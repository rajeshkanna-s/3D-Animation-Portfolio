    ...
    <div className="project-app">
      ...
      <header className="app-header">
        <a href="http://localhost:5000" className="brand-badge">
          <span className="port-pill">PORT 5211</span>
      ...
      <section className="stage-section">
        <div className="hud-overlay">
          <div className="hud-pill">
            <span>● SCENE 11</span>
            <span>·</span>
            <span>Coffee Technology & Thermodynamics</span>
          </div>
          <h1 className="hud-title">From Bean to Cup</h1>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '13px', marginTop: '6px', maxWidth: '460px' }}>
            Precision thermodynamics behind every extraction.
          </p>
        </div>
      ...
      <section className="case-study-section">
        <div className="container">
          ...
          <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(32px, 4vw, 54px)', fontWeight: 400, color: '#FFF', lineHeight: 1.05 }}>
            From Bean to Cup — Architectural &amp; Interactive Engineering
          </h2>
          ...
          <div className="project-footer-nav">
            <a href="http://localhost:5210" className="btn-nav">
              ← Prev: Atelier (5210)
            </a>
            <a href="http://localhost:5000" className="btn-nav btn-hub">
              Master Portfolio Hub (Port 5000)
            </a>
            <a href="http://localhost:5212" className="btn-nav">
              Next: Living Modules (5212) →
            </a>
          </div>
        </div>
      </section>
